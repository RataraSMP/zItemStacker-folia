package fr.maxlego08.itemstacker.zcore.utils.players;
...
import fr.maxlego08.itemstacker.zcore.utils.interfaces.StringConsumer;
...
public class BarApi {
	...
	private void barTask(BossBar bar, Runnable runnable) {
		this.foliaLib.getScheduler().runTimer(new Consumer<com.tcoded.folialib.wrapper.task.WrappedTask>() {
